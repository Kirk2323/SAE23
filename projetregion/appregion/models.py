...
class Champ(models.Model):
    ...
    def __str__(self):
        chaine2 = f"Alias : {self.alias}, Âge : {self.age}, Sexe : {self.sexe}, Classification {self.classification}"
        return chaine2

    def dico(self):
        return{'Alias' : self.alias,'Âge' : {self.age}, 'Sexe' : self.sexe, 'Classification': self.classification}
